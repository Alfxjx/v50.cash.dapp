...
export function TheFooter() {
    return (
        <footer className="w-full bg-black bg-cover bg-center text-white" style={{
            backgroundImage: 'https://assets.website-files.com/63904f663019b0d8edf8d57c/6399731b4cdf484f42d3d80b_Mask%20group%20(2).svg'
        }}>
